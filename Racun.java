...
public class Racun {
    ...
    public void dizanjeNovca(double iznos){
        this.stanjeRacuna -= iznos;
        izvod.add(new Isplata(iznos, this.brojRacuna));
        System.out.println("Uspjesno ste podigli " + iznos + "KM sa Vaseg racuna, novo stanje : " + this.stanjeRacuna);
    }

    public void uplataNovca(double iznos){
        this.stanjeRacuna += iznos;
        izvod.add(new Uplata(iznos, this.brojRacuna));
    ...
    public void transferNovca(double iznos, Racun racunPrimaoca){
        ...
        this.izvod.add(new Transfer(iznos,this.brojRacuna, racunPrimaoca.brojRacuna));
        racunPrimaoca.izvod.add(new Transfer(iznos,this.brojRacuna, racunPrimaoca.brojRacuna));
