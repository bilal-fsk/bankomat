...
public class Bankomat {
    ...
    public void prepoznajOpciju(int opcija, Banka banka){
        switch (opcija){
            ...
            case 2:
                System.out.println("Unesite sumu koju zelite podici sa racuna");
                ...
                if(iznosZaIsplatu%10!=0){
                    ...
                    System.out.println("Nedovoljno sredstavana na racunu.");
                }else{
            ...
            case 3:
                System.out.println("Unesite sumu koju zelite uplatiti na racun");
            ...
            case 4:
                System.out.println("Unesite sumu koju zelite uplatiti na racun");
                double iznosZaTransfer = Integer.valueOf(scanner.nextLine());
                System.out.println("Unesite broj racuna na koji zelite uplatiti sumu");
